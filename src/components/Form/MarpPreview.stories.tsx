...
export default {
  component: MarpPreview,
  title: 'MarpPreview',
};

const Template: ComponentStory<typeof MarpPreview> = (args) => (
  <MarpPreview {...args} />
);
...
export const Transporter = Template.bind({});
Transporter.args = {
  markdown: T6,
};
...
export const CustonRender = Template.bind({});
CustonRender.args = {
  markdown: T6,
  customRender: customRendererList,
};
